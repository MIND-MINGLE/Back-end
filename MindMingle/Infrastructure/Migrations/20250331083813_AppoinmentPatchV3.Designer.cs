...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250331083813_AppoinmentPatchV3")]
    partial class AppoinmentPatchV3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entity.Specialization", b =>
                {
            ...
            modelBuilder.Entity("Domain.Entity.Therapist_Specialization", b =>
                {
                    b.Property<string>("Therapist_SpecializationId")
                        .HasColumnType("varchar(255)");
                    ...
                    b.HasKey("Therapist_SpecializationId");

                    b.HasIndex("SpecializationId");

                    b.HasIndex("TherapistId");

                    b.ToTable("Therapist_Specialization");
                });
            ...
            modelBuilder.Entity("Domain.Entity.Appointment", b =>
                {
                    ...
                    b.HasOne("Domain.Entity.ChatGroup", "ChatGroup")
                        .WithOne("Appointment")
                        .HasForeignKey("Domain.Entity.Appointment", "GroupChatId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entity.Therapist_Specialization", b =>
                {
                    b.HasOne("Domain.Entity.Specialization", "Specialization")
                        .WithMany("Therapist_Specializations")
            ...
            modelBuilder.Entity("Domain.Entity.Specialization", b =>
                {
                    b.Navigation("Therapist_Specializations");
                });
